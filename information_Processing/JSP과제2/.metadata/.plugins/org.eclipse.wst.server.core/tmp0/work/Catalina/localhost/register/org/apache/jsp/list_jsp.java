 ...
 * Generated at: 2022-08-23 11:26:00 UTC
...
return;
    ...
    try {
      ...
      out.write("<h2 style=\"text-align:center\"><b>교과목 목록 조회/수정</b></h2>\r\n");
...
try{
	...
	while(rs.next()){
      ...
      out.print(end );
      out.write("</td>\r\n");
      out.write("\t\t<td><a href=\"action.jsp?id=");
      out.print(rs.getString(1));
      out.write("&mode=delete\">삭제</a></td>\r\n");
      out.write("\t</tr>\r\n");
